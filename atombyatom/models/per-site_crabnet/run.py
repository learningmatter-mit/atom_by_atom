...
from crabnet.data import PerSiteData
from crabnet.data import get_train_val_test_loader
from crabnet.model import PerSiteCrabNet#, BindingEnergyCGCNet 
...
def main(args):
    ...
    # NEED TO REDO HOW I DO MY NORMALIZER
    _, sample_target, _ = default_collate(sample_data_list)
    normalizer = Normalizer(sample_target)

    # examples to use to make lengths
    embedding, target_tensor, _ = dataset[0]
