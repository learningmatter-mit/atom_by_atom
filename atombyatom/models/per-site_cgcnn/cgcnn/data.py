...
class PerSiteData(Dataset):
    ...
    def compute_item(self, cif_id, crystal):
        ...
        target = [site_props[i] if i in site_props.keys() else [float('nan')]*len(crystal) for i in [self.prop_to_predict]] # set up for self.prop_to_predict being a single property rather than list of properties... fix later?
