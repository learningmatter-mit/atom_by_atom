...
def main(args):
    ...
    # Save Test Results
    pkl.dump(test_ids, open(f"{args.savedir}/test_ids3.pkl", "wb"))
    pkl.dump(test_preds, open(f"{args.savedir}/test_preds3.pkl", "wb"))
    pkl.dump(test_targets, open(f"{args.savedir}/test_targs3.pkl", "wb"))
    if details["multifidelity"]:
        pkl.dump(
