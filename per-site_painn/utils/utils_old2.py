...
# utilities for analyzing the pdos
...
class BulkPDOSAnalyzer():
    ...
    def __init__(
        ...
        self.opt_config = 'pbe_u_paw_spinpol_opt_vasp'
        ...
        self.site_magmoms = self.get_site_magmoms()
        self.site_bader_charges = self.get_site_bader_charges()
    ...
    def get_site_magmoms(self):
        ...
        magmoms = opt_parent.calcs.filter(props__magmoms__isnull=False)
        if magmoms.exists():
    ...
    def structure_with_site_properties(self):
        ...
        site_properties = self.site_bandcenters
        site_properties.update({'magmoms':self.site_magmoms})
        site_properties.update({'bader':self.site_bader_charges})
